...
\begin{document}
	...
	\begin{tikzpicture}[
		...
		\draw[-{Triangle[length=3,width=2]},dotted] (l1) -- (l2);
		\draw[->,dashed] (rwlsa1.east) -- (l2);
		\draw[->,dashed] (rwlsb1.east) -- (l2);
		...
		\draw[-{Triangle[length=3,width=2]},dotted] (l4) -- (l5);
		\draw[->,dashed] (rwlsa2.east) -- (l5);
		\draw[->,dashed] (rwlsb2.east) -- (l5);
		...
		%---------------------------------
		% Layer 7
		\node[stop] (l6) at (\yshifth,0) {$L$};
		\draw[-{Triangle[length=3,width=2]},dotted] (l5) -- (l6);
		...
		%---------------------------------
		% Legend
		\node[solution] (si) at (\yshiftlegend,-\legenddist) {$S_i$};
		...
		\node[stop,anchor=west,xshift=\legendsep] (li) at (wit.east) {$L$};
		\node[anchor=west] (lit) at (li.east) {Limit (RWLS steps)};
